...
public class TestLinkUtils {
	...
	public static void setTestResult(String project, String build, String testPlan, String ct, String note, String result) {
		try {
	...
	public static void uploadEvidence(String executionId) {
		try {
			...
			api.uploadExecutionAttachment(
				...
				"Evid�ncia de teste",
				"Durante a execucao os prints foram colocados no documento .pdf em anexo",
				Evidencia.getNome(),
				"document/pdf",
				fileContent
			); 
